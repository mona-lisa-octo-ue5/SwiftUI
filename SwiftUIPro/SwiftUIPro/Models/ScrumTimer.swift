...
class ScrumTimer: ObservableObject {
    ...
    private var secondsElapedForSpeaker:Int=0
    ...
    private func update(secondsElapsed:Int){
        secondsElapedForSpeaker=secondsElapsed
        self.secondsElapsed=secondsPerSpeaker*speakerIndex+secondsElapedForSpeaker
        ...
        if secondsElapedForSpeaker>=secondsPerSpeaker {
            changeToSpeaker(at: speakerIndex+1)
